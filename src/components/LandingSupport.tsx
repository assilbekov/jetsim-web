        ...
        <div className="w-full h-full bg-gradient-to-br from-[rgba(55,18,0,0.2)] to-[rgba(55,18,0,0.00)] rounded-none md:rounded-xl">
          <div className="flex flex-col justify-between h-full w-full md:w-1/2 p-6 md:pt-12 md:pb-14 md:pl-14">
            <div className="flex flex-col gap-2 md:gap-4">
              ...
              <h3 className="text-2xl leading-[30px] text-center font-medium md:text-5xl md:leading-[58px] text-text-900">
          ...
          <div className="hidden md:block bg-[url('/support-person.png')] bg-cover h-[478px] w-[340px] absolute right-[10%] bottom-0" />
        </div>
      </div>
    </LandingContainer>
  );
